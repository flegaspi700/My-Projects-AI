...
root_agent = Agent(
    ...
    instruction="""
    Ask the user how their day is going, along with an additional mindful prompt.
    Then use your tool to write a brief journal entry.
    For continued entries, don't use the conversation history
    before your previous function call.
    """,
